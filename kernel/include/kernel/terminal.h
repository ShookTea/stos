 ...
 * - white          (FE = 37, BE = 47)
 * - gray           (FE = 90, BE = 100)
 * - bright red     (FE = 91, BE = 101)
 * - bright green   (FE = 92, BE = 102)
 * - bright brown   (FE = 93, BE = 103)
 * - bright blue    (FE = 94, BE = 104)
 * - bright magenta (FE = 95, BE = 105)
 * - bright cyan    (FE = 96, BE = 106)
 * - bright white   (FE = 97, BE = 107)
 */
